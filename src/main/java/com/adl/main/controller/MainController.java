...
import com.adl.main.model.FaqsDiseaseModel;
import com.adl.main.model.MockPostModel;
import com.adl.main.model.PreventionModel;
import com.adl.main.repository.FaqsDiseaseRepository;
...
public class MainController {
	...
	@Autowired
	FaqsDiseaseRepository faqsRepo;
	...
	public String faqs(Model model) {
		List<FaqsDiseaseModel>lstFaqs= faqsRepo.findAll();
		model.addAttribute("lstFaqs",lstFaqs);
		return "faqs";
	}
	
	@GetMapping("/faqs/input")
	public String getInputFaqsDisease(Model model) {
		
		model.addAttribute("faqsModel", new FaqsDiseaseModel());
		return "input_faqs";
	}
	
	@PostMapping("/faqs/input")
	public String inputFaqsDisease(
			@ModelAttribute("faqsModel") FaqsDiseaseModel data,
			Model model,
